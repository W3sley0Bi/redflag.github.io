const perks = [
    ...
    'Supermodel',
    'Professional chef',
    "Is never gonna give you up / Let you down / Run around / Or desert you", "World's best hair stylist", "Brain surgeon", "Lawyer", "CEO", "World's best advertising executive", "Airline pilot", "Marine", "Spin instructor", "Bestselling author", "YouTube celebrity", "Lumberjack", "Organic farmer", "Stunt double", "Park ranger", "Ski instructor", "Photographer", "Famous fashion designer", "Is royalty", "Is a genie", "World champion _____", "World champion hunter", "Won the medal of honor", "Was on the news for rescuing a kitten", "Best-smelling person in the world", "Yoga instructor", "The hot barista", "Has an 8-pack", "Olympic gymnast", "Pick an actor/actress", "Never arrives prematurely", "Loves to cuddle", "Is a vampire... / the sexy kind", "Has the most attractive _____ you've ever seen", "The lead singer of your favorite band", "Beautiful eyes", "Completely blind to all of your flaws", "Spontaneous and fun", "Makes you feel secure", "Has the hottest friends", "Has a twin", "Life is the true story that _____ is based on", "Can fly", "Superhero", "Loves to laugh", "Makes scented candles", "Loves the '80s", "Cooks all your favorite foods", "Knows all the words to your favorite children's TV theme songs", "Never blames you for anything", "Can get you free drinks forever at any bar in the world", "Creates shelters for the homeless", "Their kisses cure cancer", "Is a great conversationalist", "Gives the best hugs", "Gives you multiple orgasms", "Is a merperson", "Always knows how to stop you from crying", "Can multiply themselves", "An amazing dancer", "Always defends you", "Can get you a table at any 5-star restaurant any time any place", "Can fire your most hated co-worker or boss", "Their farts smell like flowers", "Never farts", "Their morning breath smells like fresh-baked cookies", "Owns Mars", "Is a night person and a morning person", "Loves their job", "Has all the same hobbies as you", "Can talk to animals", "Owns real dinosaurs", "Gives great massages"]
const flags = [
...
"As long as you date them you can only eat food off the dollar menu"
 ...
 function processLineByLine(arr, n) {
    let numRandom = 0
    let temp = []
    for (let i = 0; i < n; i++) {
